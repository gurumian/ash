...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  // User Ask API (for Agent)
  onAskUser: (callback) => ipcRenderer.on('ipc-ask-user', (event, data) => callback(data)),
  offAskUser: (callback) => ipcRenderer.off('ipc-ask-user', callback),
  sendAskUserResponse: (requestId, response) => ipcRenderer.invoke(`ipc-ask-user-response-${requestId}`, response),
});
